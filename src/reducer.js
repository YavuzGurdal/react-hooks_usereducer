export const reducer = (state, action) => { // iki parametre alir. state ve action
    ...
    switch (action.type) {
        ...
        case "FETCH_START": // api den verilerin alinmaya basladigi an
            return { ...state, data: "", loading: true, error: "" }; // state bu veriler ile guncelliyoruz

        case "FETCH_SUCCESS": // api den verilerin alinmasi basarili oldugu an
        ...
        case "FETCH_ERROR": // api den verilerin alinmasi basarisiz oldugu an
